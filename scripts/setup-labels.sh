...
create_label "agent:reviewer"             "FFD600" "Reviewer 에이전트 담당"
create_label "agent:qa"                   "00B8D4" "QA 에이전트 담당"
create_label "agent:auditor"              "E67E22" "Auditor 에이전트 담당"
create_label "agent:integrator"           "1ABC9C" "Integrator 에이전트 담당"
create_label "agent:skill-creator"        "8E44AD" "Skill Creator 에이전트 담당"
create_label "agent:cross-validator"      "2C3E50" "Cross Validator 에이전트 담당"
create_label "agent:devops"               "34495E" "DevOps 에이전트 담당"
create_label "agent:releaser"             "27AE60" "Releaser 에이전트 담당"
...
create_label "status:review"      "D876E3" "리뷰 대기"
...
create_label "status:reviewing"   "C9DEF8" "리뷰 진행 중"
create_label "status:testing"     "BFD4F2" "테스트 진행 중"
create_label "status:audit-passed" "0E8A16" "정적 분석 통과"
create_label "status:qa-passed"   "0E8A16" "QA 테스트 통과"
